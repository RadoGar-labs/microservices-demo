...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    ...
    yor_trace = "c6715f3c-81d2-4d15-bfc1-18a4d61be407"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    ...
    git_org   = "RadoGar-labs"
    git_repo  = "microservices-demo"
    yor_trace = "cf3f3a89-8d30-494d-8bc7-e43ac11ca1e1"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    ...
    git_org   = "RadoGar-labs"
    git_repo  = "microservices-demo"
    yor_trace = "7fee8ff5-f265-4b7c-8248-dca7c6778522"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    ...
    git_org   = "RadoGar-labs"
    git_repo  = "microservices-demo"
    yor_trace = "796c9ad5-ffb1-41ae-9977-c6a635a5b62c"
  }
}
